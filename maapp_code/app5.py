                ...
                for e in l:
                    if e.get('status') == 0:
                        ...
                        for p in str.split(pageListStr,'-'):
                            ...
                            data_id0 = BeautifulSoup(jsonobj['list'][0][0], "html.parser").span.attrs["data-id"]
                            global last_max_data_id
                            global cur_max_data_id
                            if int(data_id0)<=int(last_max_data_id):
                                sleep(3)
                                last_max_data_id=cur_max_data_id
                                break
            ...
            try:
                ...
                if current_cicle != soup2.span.text:
                    ...
                    if len(jsonobj['list'])>0:
                       ...
                       # 告警处理 第N>1次有数据
                            ...
                            if (last_max_data_id == cur_max_data_id):
                                sleep(5)
                                continue
                ...
                for i in range(totalPage):
                    ...
                    if threadDic.get(threadName)!=None:
                        ...
                        cur_max_data_id
                        e['cur_max_data_id']=cur_max_data_id

...
IMAGES_PATH = 'F:\\知识星球\\生财有术\\20190904-2\\merge_img\\'  # 图片集地址
IMAGES_FORMAT = ['.jpg', '.JPG', '.png', '.PNG']  # 图片格式
IMAGE_SIZE = 256  # 每张小图片的大小
IMAGE_ROW = 13  # 图片间隔，也就是合并成一张图后，一共有几行
IMAGE_COLUMN = 1  # 图片间隔，也就是合并成一张图后，一共有几列
IMAGE_SAVE_PATH = 'F:\\知识星球\\生财有术\\20190904-2\\merge_img\\final.jpg'  # 图片转换后的地址
